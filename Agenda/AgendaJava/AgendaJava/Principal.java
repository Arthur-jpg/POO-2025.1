...
public class Principal {
    ...
    public static void main(String[] args) {
        ...
        // seta uma conexão com o banco de dados
        ConnectionFactory fabricaDeConexao = new ConnectionFactory();
        // recupera a conexão com o banco de dados
        Connection connection = fabricaDeConexao.recuperaConexao();
        // cria o objeto PessoaDAO passando a conexão como parâmetro para poder acessar os metodos de salvar, atualizar, excluir e listar pessoas
        PessoaDAO pdao = new PessoaDAO(connection);
        // salva no banco de dados as pessoas criadas em memoria
        pdao.salvar(pessoa1);
        pdao.salvar(pessoa2);
        pdao.salvar(pessoa3);
        pdao.salvar(pessoa4);
